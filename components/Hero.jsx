...
const Hero = () => {
  ...
  return (
    <section
      className="flex flex-col min-[900px]:flex-row justify-center items-center h-[1600px] min-[768px]:h-[1250px]  min-[900px]:h-screen w-full overflow-hidden min-[1024px]:mt-[150px] min-[1100px]:mt-[50px]"
      id="hero"
    >
